...
As an alternative, individual data analysis steps can be performed with alternative methods and integrated into `ParticleTracking` workflow, either with data import/export or source code modification.
