...
from PyQt5.QtWidgets import QLabel, QSizePolicy, QScrollArea, QMessageBox, QMainWindow, QMenu, QAction, qApp, \
    QFileDialog
...
class QImageViewer(QMainWindow):
    def __init__(self):
        ...
        vlay = QVBoxLayout(self.main_widget)
        # Back - Forward
        pybuttonB = QPushButton('Back', self)
        # pybuttonB.clicked.connect(self.clickMethod)
        pybuttonF = QPushButton('Forward', self)
        # pybuttonF.clicked.connect(self.clickMethod)

        hlay3 = QHBoxLayout()
        hlay3.addWidget(pybuttonB)
        hlay3.addWidget(pybuttonF)
    ...
    def about(self):
        QMessageBox.about(self, "About Image Viewer", "<p>The <b>Image Viewer</b> example shows how to combine "
