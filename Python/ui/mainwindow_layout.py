...
# Form implementation generated from reading ui file './ui/mainwindow_layout.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("./ui/resources/icon_main.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        self.scrollAreaWidgetContents_0.setGeometry(QtCore.QRect(0, 0, 441, 226))
        ...
        self.camera_0.setPixmap(QtGui.QPixmap("./ui/resources/icon_main.ico"))
        ...
        self.scrollAreaWidgetContents_8.setGeometry(QtCore.QRect(0, 0, 441, 226))
        ...
        self.camera_1.setPixmap(QtGui.QPixmap("./ui/resources/icon_main.ico"))
        ...
        self.lbl_rodslist = QtWidgets.QLabel(self.verticalLayoutWidget)
        font = QtGui.QFont()
        font.setPointSize(9)
        font.setBold(True)
        font.setWeight(75)
        self.lbl_rodslist.setFont(font)
        self.lbl_rodslist.setStyleSheet("background-color: transparent;font-weight: bold;")
        self.lbl_rodslist.setAlignment(QtCore.Qt.AlignCenter)
        self.lbl_rodslist.setObjectName("lbl_rodslist")
        self.undo_layout.addWidget(self.lbl_rodslist)
        self.lv_rods = QtWidgets.QListWidget(self.verticalLayoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lv_rods.sizePolicy().hasHeightForWidth())
        self.lv_rods.setSizePolicy(sizePolicy)
        self.lv_rods.setMaximumSize(QtCore.QSize(400, 16777215))
        self.lv_rods.setObjectName("lv_rods")
        self.undo_layout.addWidget(self.lv_rods)
        self.lbl_actions_list = QtWidgets.QLabel(self.verticalLayoutWidget)
        ...
        self.undo_layout.addWidget(self.lbl_actions_list)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("./ui/resources/left-arrow-96.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lbl_rodslist.setText(_translate("MainWindow", "List of Rods:"))
