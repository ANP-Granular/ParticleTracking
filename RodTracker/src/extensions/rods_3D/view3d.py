...
class View3DTab(tabs.UtilityTab):
    def __init__(self, id: str = "unknown", *args, **kwargs):
        ...
        self.view_3d = View3D(parent=self)
        self.view_3d.setSizePolicy(
            QtWidgets.QSizePolicy.Preferred,
            QtWidgets.QSizePolicy.Expanding,
        )
        self.pb_front = QtWidgets.QPushButton("Front", self)
        self.pb_top = QtWidgets.QPushButton("Top", self)
        controls_spacer = QtWidgets.QSpacerItem(
            10,
            10,
            QtWidgets.QSizePolicy.Expanding,
            QtWidgets.QSizePolicy.Preferred,
        )
        self.cb_show_3D = QtWidgets.QCheckBox("Show 3D", self)
        self.group_3D_mode = QtWidgets.QGroupBox("", self)
        self.rb_all_3d = QtWidgets.QRadioButton("All", self.group_3D_mode)
        self.rb_color_3d = QtWidgets.QRadioButton("Color", self.group_3D_mode)
        self.rb_one_3d = QtWidgets.QRadioButton("Single", self.group_3D_mode)

        option_layout = QtWidgets.QHBoxLayout(self.group_3D_mode)
        option_layout.setContentsMargins(0, 0, 0, 0)

        self.setLayout(outer_layout)
        outer_layout.addLayout(controls_layout)
        outer_layout.addWidget(self.view_3d)
        controls_layout.addWidget(self.pb_front)
        controls_layout.addWidget(self.pb_top)
        controls_layout.addSpacerItem(controls_spacer)
        controls_layout.addWidget(self.cb_show_3D)
        controls_layout.addWidget(self.group_3D_mode)
        self.group_3D_mode.setLayout(option_layout)
        option_layout.addWidget(self.rb_all_3d)
        option_layout.addWidget(self.rb_color_3d)
        option_layout.addWidget(self.rb_one_3d)

    @QtCore.pyqtSlot(lg.Action)
    def undo_action(self, _: lg.Action):
        # TODO: evaluate, if something is necessary here
        pass
